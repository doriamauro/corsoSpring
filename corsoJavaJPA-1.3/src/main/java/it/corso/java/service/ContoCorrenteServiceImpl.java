...
//	@Transactional(propagation = Propagation.REQUIRES_NEW, isolation = Isolation.DEFAULT ,readOnly = false)
	@Override
...
//			m.setId(++progressivoMovimento); //exception a runtime
	...
	public ContoCorrente modificaSaldo(int numeroConto, double importo, Integer userId, Integer versione) {
		...
		if(cc.getVersione()!= versione) throw new StaleStateException("oggetto vecchio");
